        ...
        return (
            <div className="skill-box">
                <div className="skill-logo">
                    <a href="https://www.w3.org/TR/2011/WD-html5-20110405/"><img src={htmlimg} alt="html" width="100px"></img></a>
                    <a href="https://www.w3schools.com/cssref/index.php"><img src={cssimg} alt="css" width="100px"></img></a>
                    <a href="https://developer.mozilla.org/pt-BR/docs/Web/JavaScript"><img src={jsimg} alt="javascript" width="100px"></img></a>
                    <a href="https://pt-br.reactjs.org/docs/getting-started.html"><img src={reactimg} alt="reactjs"width="100px"></img></a>
                    <a href="https://nodejs.org/pt-br/docs/"><img src={nodejsimg} alt="nodejs" width="100px"></img></a>
                </div>
